...
| Native operator | [Operations](OPERATIONS.md) | [Configuration](CONFIGURATION.md), [Troubleshooting](TROUBLESHOOTING.md) |
...
| Renderer operator | [Architecture](ARCHITECTURE.md) | [ComfyUI remote GPU](COMFYUI_REMOTE_GPU.md), [stable-diffusion.cpp](SDCPP_LOCAL_RENDERER.md) |
...
| Maintainer | [Release](RELEASE.md) | [Status](STATUS.md), [Security](../SECURITY.md), [Changelog](../CHANGELOG.md) |
